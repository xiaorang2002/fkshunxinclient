...
import { GameUI_ZJH } from './GameUI_ZJH';
...
@ccclass
export default class ZjhGameOver_UI extends BaseUI {

    protected static className = "ZjhGameOver_UI";
    public static getUrl(): string {
        LogWrap.info(this.className);
        return GameConstValue.ConstValue.UI_ZJH_DIR + this.className;
    }
    ...
    public dismissed() {
        if (UIManager.getInstance().getUI(GameUI_ZJH)) {
            if (this._clubid == 0) {
                //转场大厅
