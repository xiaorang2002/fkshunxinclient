...
@ccclass
export class RuleUI_LFMJ extends BaseRuleUI {
    protected static className = "RuleUI_LFMJ";
    private gpsList = [100,300,500,1000]

    private ruleInfo = {
        ju_shu: 0, // 局数下标
        zf: [true, false, false],  // AA支付 老板支付 房主支付
        wf: [true, false],  // 三人局 二人局
        wf2: [false, false],  // 估卖
        ji1: [true, false], // 翻牌鸡 摇摆鸡
        ji2: [false, false, false, false, false], // 本鸡， 乌骨鸡， 星期鸡， 吹风鸡， 地龙
        zhuang: [true, false, false], // 一扣二 连庄 通三
    ...
    private initRuleInfoByData(ruleInfo)
    {
        if (ruleInfo)
        {
            ...
            this.ruleInfo.wf[oRule.room.player_count_option] = true
            this.ruleInfo.wf2[0] = oRule.play.gu_mai
            this.ruleInfo.wf2[1] = oRule.play.hu_tips
            ...
            this.ruleInfo.ji2[4] = oRule.play.di_long
            this.ruleInfo.zhuang[0] = oRule.play.win_zhuang
        ...
        {
            let save_rule_lfmj = cc.sys.localStorage.getItem("rule_lfmj");
            if (save_rule_lfmj != null) {
                this.ruleInfo = JSON.parse(save_rule_lfmj);
                cc.sys.localStorage.removeItem("rule_lfmj");
            }
        }
    ...
    public updateView() {
        ...
        this.toggle_wf[this.ruleInfo.wf.indexOf(true)].check();
        this.ruleSelect(this.toggle_wf[this.ruleInfo.wf.indexOf(true)], true);
        ...
        this.node.setContentSize(936, 900);
        this.isInit = false;
    ...
    public getRule()
    {
        ...
        var rule = {
            ...
            room: {player_count_option: this.ruleInfo.wf.indexOf(true)},
            play: {
                gu_mai: this.ruleInfo.wf2[0], // 估卖
                hu_tips: this.ruleInfo.wf2[1],
                ...
                di_long:this.ruleInfo.ji2[4],// 地龙
                win_zhuang: this.ruleInfo.zhuang[0], // 赢家坐庄
                lian_zhuang: this.ruleInfo.zhuang[1],// 连庄
                tong_san: this.ruleInfo.zhuang[2],// 通三
    ...
    public saveRule()
    {
        cc.sys.localStorage.setItem("rule_lfmj", JSON.stringify(this.ruleInfo));
    }
    ...
    public btn_wanfa(event, customEventData)
    {
        var originSelectIndex = this.ruleInfo.wf.indexOf(true)
        this.ruleSelect(this.toggle_wf[originSelectIndex], false);
        this.ruleInfo.wf[originSelectIndex] =false
        this.ruleInfo.wf[parseInt(customEventData)] = true;
        this.ruleSelect(this.toggle_wf[parseInt(customEventData)], true);
    }
