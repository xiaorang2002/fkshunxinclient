...
@ccclass
export class RuleUI_XZMJ extends BaseRuleUI {
    protected static className = "RuleUI_XZMJ";
    ...
    private ruleInfo = {
        ...
        ren: [true, false, false],
        huan1: [true, false, false], // 换三张，换四张
        huan2: [true, false], // 单色换，任意换
        wf1: [true, false ], // 自摸加翻，自摸加底
        wf2: [true, false ], // 点杠花（点炮，自摸）
        wf3: [true, false], // 查大叫，查小叫
        wf4: [true, true, false, false, false, false, false, false,false],
    ...
    private initRuleInfoByData(ruleInfo)
    {
        if (ruleInfo)
        {
            ...
            this.ruleInfo.wf4[0] = oRule.play.men_qing
            this.ruleInfo.wf4[1] = oRule.play.zhong_zhang
            this.ruleInfo.wf4[2] = oRule.play.tian_di_hu
            this.ruleInfo.wf4[3] = oRule.play.hai_di
            this.ruleInfo.wf4[4] = oRule.play.guo_zhuang_hu
            this.ruleInfo.wf4[5] = oRule.room.dismiss_all_agree
            this.ruleInfo.wf4[6] = oRule.play.jin_gou_gou
            this.ruleInfo.wf4[7] = oRule.play.exchange_tips
            this.ruleInfo.wf4[8] = oRule.play.hu_tips
        ...
        {
            let save_rule_xzmj = cc.sys.localStorage.getItem("rule_yjmj");
            if (save_rule_xzmj != null) {
                ...
                cc.sys.localStorage.removeItem("rule_yjmj");
            }
        }
    }
    ...
    public updateView() {
        ...
        this.node.setContentSize(936, 1760);
        this.isInit = false;
    ...
    public getRule()
    {
        ...
        var rule = {
            ...
            play: {zi_mo_jia_fan: this.ruleInfo.wf1[0], // 自摸加翻
                ...
                men_qing: this.ruleInfo.wf4[0], // 门清
                zhong_zhang: this.ruleInfo.wf4[1], // 中张
                tian_di_hu: this.ruleInfo.wf4[2], // 天地胡
                hai_di: this.ruleInfo.wf4[3], //  海底
                guo_zhuang_hu: this.ruleInfo.wf4[4], // 过手胡
                jin_gou_gou: this.ruleInfo.wf4[6], // 金钩钩
                exchange_tips: this.ruleInfo.wf4[7],
                hu_tips: this.ruleInfo.wf4[8], // 胡牌提示
    ...
    public saveRule()
    {
        cc.sys.localStorage.setItem("rule_yjmj", JSON.stringify(this.ruleInfo));
