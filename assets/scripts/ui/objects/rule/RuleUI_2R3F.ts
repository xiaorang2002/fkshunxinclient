...
export class RuleUI_XZMJ extends BaseRuleUI {
    ...
    private ruleInfo = {
        ...
        wf4: [false, false, false, false, false, false, false, false, false], // 幺九将对，门清中张，天地，胡牌提示，夹心五，2分起胡，换牌提示
    ...
    private initRuleInfoByData(ruleInfo)
    {
        if (ruleInfo)
        {
            ...
            if (oRule.play.jia_xin_5)
                this.ruleInfo.wf4[4] = true
            else
                this.ruleInfo.wf4[4] = false
            this.ruleInfo.wf4[5] = oRule.room.hu_at_least_2
            this.ruleInfo.wf4[6] = oRule.play.exchange_tips
        ...
        {
            let save_rule_2r3f = cc.sys.localStorage.getItem("rule_2r3f");
            if (save_rule_2r3f != null) {
                var saveInfo = JSON.parse(save_rule_2r3f);
                saveInfo.zf = this.ruleInfo.zf
                if (saveInfo.gn.length != 4)
                    saveInfo.gn[3] = true
                this.ruleInfo = saveInfo
                cc.sys.localStorage.removeItem("rule_2r3f");
            }
        }
    }
    ...
    public getRule()
    {
        ...
        var rule = {
            ...
            play: {zi_mo_jia_fan: this.ruleInfo.wf1[0], // 自摸加翻
                ...
                jia_xin_5: this.ruleInfo.wf4[4], // 夹心5
                hu_at_least_2:this.ruleInfo.wf4[5], // 2分起胡
                exchange_tips: this.ruleInfo.wf4[6], // 换牌提示
                da_dui_zi_fan_2: this.ruleInfo.wf4[7], // 对对胡2番
    ...
    public saveRule()
    {
        cc.sys.localStorage.setItem("rule_2r3f", JSON.stringify(this.ruleInfo));
