...
export class RuleUI_XZMJ extends BaseRuleUI {
    ...
    private ruleInfo = {
        ...
        wf4: [false, false, false, false, false, false, false, false,false], // 幺九将对，门清中张，天地，胡牌提示， 放牛必须过庄胡，解散需要所有人同意，过手碰，换牌提示
    ...
    private initRuleInfoByData(ruleInfo)
    {
        if (ruleInfo)
        {
            ...
            this.ruleInfo.wf4[6] = oRule.play.guo_shou_peng
            this.ruleInfo.wf4[7] = oRule.play.exchange_tips
            this.ruleInfo.wf4[8] = oRule.play.da_dui_zi_fan_2
        ...
        {
            let save_rule_xzmj = cc.sys.localStorage.getItem("rule_xzmj");
            if (save_rule_xzmj != null) {
                ...
                cc.sys.localStorage.removeItem("rule_xzmj");
            }
        }
    }
    ...
    public updateView() {
        ...
        this.node.setContentSize(936, 1700);
        this.isInit = false;
    ...
    public getRule()
    {
        ...
        var rule = {
            ...
            play: {zi_mo_jia_fan: this.ruleInfo.wf1[0], // 自摸加翻
                ...
                guo_shou_peng: this.ruleInfo.wf4[6], // 过手碰
                exchange_tips: this.ruleInfo.wf4[7],
                da_dui_zi_fan_2: this.ruleInfo.wf4[8], // 对对胡2番
    ...
    public saveRule()
    {
        cc.sys.localStorage.setItem("rule_xzmj", JSON.stringify(this.ruleInfo));
