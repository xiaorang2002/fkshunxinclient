...
@ccclass
export class RuleUI_2R2F extends BaseRuleUI {
    protected static className = "RuleUI_2R2F";
    ...
    private ruleInfo = {
        ...
        wf4: [false, false, false, false, false, false,false], // 幺九将对，门清中张，天地，胡牌提示，2分起胡，换牌提示
    ...
    private initRuleInfoByData(ruleInfo)
    {
        if (ruleInfo)
        {
            ...
            this.ruleInfo.wf4[5] = oRule.play.exchange_tips
        ...
        {
            let save_rule_2r2f = cc.sys.localStorage.getItem("rule_2r2f");
            if (save_rule_2r2f != null) {
                var saveInfo = JSON.parse(save_rule_2r2f);
                saveInfo.zf = this.ruleInfo.zf
                if (saveInfo.gn.length != 4)
                    saveInfo.gn[3] = true
                this.ruleInfo = saveInfo
                cc.sys.localStorage.removeItem("rule_2r2f");
            }
        }
    }
    ...
    public updateView() {
        ...
        this.node.setContentSize(936, 1530);
        this.isInit = false;
    ...
    public getRule()
    {
        ...
        var rule = {
            ...
            play: {zi_mo_jia_fan: this.ruleInfo.wf1[0], // 自摸加翻
                ...
                hu_at_least_2: this.ruleInfo.wf4[4],       
                exchange_tips: this.ruleInfo.wf4[5],  
    ...
    public saveRule()
    {
        cc.sys.localStorage.setItem("rule_2r2f", JSON.stringify(this.ruleInfo));
